...
var ownerId = '607692275392446474'; //My ID
...
client.on('ready', () => { //Startup
  console.log("Bot on!");
  client.user.setUsername("WARM LIGHT");
...
client.on('guildCreate', guild => { // If the Bot was added on a server, proceed
  ...
  var welcome = new Discord.RichEmbed()
    .setColor(0x000000)
    .setURL("https://discord.gg/54vyaDj")
    .setTitle("Joined " + guild.name + " | Click to join support server")
    .setDescription("**Well, hello, I think.**\n\nMy name is WARM LIGHT, as you can see. I'm just a bot. Perfect bot. Another, same as other millions bots.\n\n")
